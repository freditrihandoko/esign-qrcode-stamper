...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        // If a signature is uploaded, store it and update the user's signature_path
    ...
    <div class="grid gap-5 lg:grid-cols-2"> 
        <div>
            <x-form wire:submit="save"> 
                ...
                <x-select label="Role" wire:model="role" :options="[ ['id' => 'superadmin', 'name' => 'Superadmin'], ['id' => 'admin', 'name' => 'Admin'], ['id' => 'pimpinan', 'name' => 'Pimpinan'], ['id' => 'approver', 'name' => 'Approver'], ['id' => 'user', 'name' => 'User']]" placeholder="---" />
